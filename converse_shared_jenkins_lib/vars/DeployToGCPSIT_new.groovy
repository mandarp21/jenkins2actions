def call(String serviceName, String sitClusterNamespace ){
 ...
 echo "Install Helm client"
          wget https://get.helm.sh/helm-v2.17.0-linux-amd64.tar.gz
            ...
            ~/google-cloud-sdk/bin/gcloud container clusters get-credentials ${SIT_GKE_CLUSTER_NAME} --region us-west4 --project acn-newyork-dol-gcp
            ...
            ./linux-amd64/helm upgrade -f ./jenkins-helm/''' + serviceName + '''/values-sit.yaml ''' + serviceName + '''-sit --install --namespace ''' + sitClusterNamespace + ''' ./jenkins-helm/''' + serviceName + ''' --set image.repository="us.gcr.io/acn-newyork-dol-gcp/converse3/$SERVICE_NAME" --set image.tag=$BUILD_NUMBER-$COMMIT_ID --set tracing.enabled=true
            #echo $?
